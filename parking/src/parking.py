...
class ParkingStation:
    ...
    def addCar(self, car_num, plan_name):
        ...
        try:
            ...
            if carDataDetails.objects.filter(carno=car_num).count() == 0:
                ...
                newCar = carDataDetails.objects.create(carno=car_num,tariff_plan=tariff_plan,inTime=inTime,location=location)
                newCar.save()
    ...
    def __assignSpot(self,location):
        ...
        occupiedSlots = list(ParkingStation.jsonDec.decode(level.occupied_spots))
